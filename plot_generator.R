...
p1=ggplot(results_df, aes(idx)) + 
  ...
  scale_shape_manual(name="Test", values=c("1"=15, "2"=16), 
                      labels=c("1"=lab[1], "2"=lab[2]))+
...
p1=ggplot(results_df, aes(idx)) + 
  ...
  scale_linetype_manual(guide="none", values = c("3"="solid","4"="dashed","5"="dotted"))+
  scale_colour_manual(name="Test", values=c( "1"=col[1], "2"=col[2], "3"=col[3]), 
                      labels=c("1"=lab[1], "2"=lab[2], "3"=lab[3]))+
  scale_shape_manual(name="Test", values=c("1"=15, "2"=17, "3"=16), 
                     labels=c("1"=lab[1], "2"=lab[2], "3"=lab[3]))+
...
p1=ggplot(results_df, aes(idx)) + 
  ...
  scale_colour_manual(name="Test", values=c( "1"=col[1], "2"=col[2]), 
                      labels=c("1"=lab[1], "2"=lab[2]))+
  scale_shape_manual(name="Test", values=c("1"=15, "2"=17), 
                     labels=c("1"=lab[1], "2"=lab[2]))+
  xlab(expression(beta))+
  ylab("Numb. of samples till decision")+
  scale_x_continuous(breaks = betas, limits=c(0, max(betas)+0.03), expand = c(0, 0)) +
