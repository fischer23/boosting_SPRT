#This file runs the simulations shown in Section 3.1 of the paper 
...
#Save the results
results_df=data.frame(idx=mus, mean_stop_boosted, mean_stop_sprt, mean_type_I_boosted, mean_type_I_sprt, 
                      power_boosted, power_sprt)
